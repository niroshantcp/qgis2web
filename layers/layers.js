...
jsonSource_test_4.addFeatures(features_test_4);var lyr_test_4 = new ol.layer.Vector({
                declutter: true,
...
lyr_ESRISatellite_0.setVisible(true);lyr_District_1.setVisible(true);lyr_DSD_2.setVisible(true);lyr_GND_3.setVisible(true);lyr_test_4.setVisible(true);
var layersList = [lyr_ESRISatellite_0,lyr_District_1,lyr_DSD_2,lyr_GND_3,lyr_test_4];
...
lyr_test_4.set('fieldAliases', {'id': 'id', 'test': 'test', });
...
lyr_GND_3.set('fieldImages', {'PROVINCE_N': 'TextEdit', 'DISTRICT_N': 'TextEdit', 'DSD_N': 'TextEdit', 'GND_N': 'TextEdit', 'GND_C': 'TextEdit', 'DSDCODE4': 'TextEdit', 'GNDCODE7': 'TextEdit', 'GNDPCODE5': 'TextEdit', 'GNDPCODE3': 'TextEdit', });
lyr_test_4.set('fieldImages', {'id': '', 'test': '', });
...
lyr_test_4.set('fieldLabels', {'id': 'no label', 'test': 'no label', });
